...
function prepareTemplates() {
    return gulp.src('./src/*.html')
        ...
        .pipe(angularTemplatecache({
            module: 'schemaForm',
            root: 'directives/decorators/bootstrap/angular-schema-form-prdg-file-upload/'
        }));
}

gulp.task('build-app-dev', function() {
    return gulp.src('./src/angular-schema-form-prdg-file-upload.js')
        //.pipe(concat your app js files somehow)
        .pipe(sourcemaps.init())

        // append the template js onto one file
        .pipe(addStream.obj(prepareTemplates()))
        .pipe(concat('angular-schema-form-prdg-file-upload.js'))
...
gulp.task('build-app-prod', function() {
    return gulp.src('./src/angular-schema-form-prdg-file-upload.js')
        ...
        // append the template js onto one file
        .pipe(addStream.obj(prepareTemplates()))
        .pipe(concat('angular-schema-form-prdg-file-upload.min.js'))
